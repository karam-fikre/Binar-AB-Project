...
extern DELPHI_PACKAGE System::LongBool __fastcall TimerExpired(const EventTimer &ET);
extern DELPHI_PACKAGE int __fastcall ElapsedTime(const EventTimer &ET);
extern DELPHI_PACKAGE int __fastcall ElapsedTimeInSecs(const EventTimer &ET);
extern DELPHI_PACKAGE int __fastcall RemainingTime(const EventTimer &ET);
extern DELPHI_PACKAGE int __fastcall RemainingTimeInSecs(const EventTimer &ET);
