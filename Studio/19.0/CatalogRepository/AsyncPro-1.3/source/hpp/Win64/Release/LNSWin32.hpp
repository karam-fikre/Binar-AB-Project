...
protected:
	...
	__property NativeUInt ComHandle = {read=GetComHandle};
	__property bool DLoggingOn = {read=GetDLoggingOn, nodefault};
	__property NativeUInt GeneralEvent = {read=GetGeneralEvent};
...
protected:
	...
	__property NativeUInt OutFlushEvent = {read=GetOutFlushEvent};
	__property NativeUInt OutputEvent = {read=GetOutputEvent};
public:
